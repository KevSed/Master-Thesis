...
tasks of this analysis. A schematic representation of the analysis flows is
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}[node distance = 1.5cm, auto]
    ...
    \node (f6) [LP, below of=f4] {\begin{varwidth}{9em}\centering{pixelbased thresholds}\end{varwidth}};
    ...
    \node (f9) [both, below of=f7, xshift=2.0cm] {IACT tools};
    \node (s4) [astep, below of=s3] {separation};
    \node (f10) [both, below of=f9] {IACT tools};

...
\begin{figure}
  \centering
  \subcaptionbox{Hillas features. \label{fig:hillas}}[0.48\textwidth]{
    \includegraphics[width=0.45\textwidth]{Plots/hillas2.pdf}
  }
  \subcaptionbox{Disp method. \label{fig:disp}}[0.48\textwidth]{
